...
<%@page import="info.test.lesson.java_mysql.ShainBeans"%>
<html>
<body>
  <%
  ...
  <form action="/java_mysql/Edit" method="POST">
    ID:<%=shain.getId()%>（変更不可） <input type="hidden" name="id"
      ...
      value="<%=shain.getAddress()%>"> <br> <br> <input
      type="hidden" name="mode" value="del_add"> <input
